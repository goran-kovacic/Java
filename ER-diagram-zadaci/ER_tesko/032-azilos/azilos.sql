# c:\xampp\mysql\bin\mysql -uroot --default_character_set=utf8 < C:\Users\AMD\Documents\GitHub\ER-diagram-zadaci\ER_tesko\032-azilos\azilos.sql

drop database if exists azilos;
create database azilos;
use azilos;
